...
export const VERSUS_COMPETITORS: VersusCompetitor[] = [
  {
    ...
    name: "PermitFlow",
    initial: "P",
    cardBlurb: "National permit software. No private-provider depth.",
    headline: "The permit platform built\nfor contractors. Not retrofitted.",
    sub: "PermitFlow is a $54M platform built for scale, not depth. Cleard holds private-provider licensing, which PermitFlow does not. That means Cleard can legally submit and sign off on permits; PermitFlow cannot.",
    rows: [
      { feature: "Private-provider license", cleard: true, competitor: false },
      ...
      { feature: "Municipality intelligence", cleard: true, competitor: "Limited" },
      ...
      { feature: "Jurisdiction-specific scope flags", cleard: true, competitor: false },
      { feature: "National coverage", cleard: true, competitor: true },
    ...
    diffs: [
      {
        ...
        body: "Cleard holds private-provider certification. This means we can legally review plans and sign off on permits — not just track them. PermitFlow is a SaaS tracking layer; Cleard is a licensed permit entity.",
      },
      {
        icon: "sparkles",
        headline: "Victoria AI",
        body: "Victoria monitors every active permit, reads municipality emails, and predicts timelines based on real jurisdiction data. PermitFlow has no AI advisor layer.",
      },
      {
        icon: "layers",
        headline: "Real depth, not just support",
        body: "PermitFlow covers 50 states and treats every market the same. Cleard is built around the way permits actually move — every feature designed for real municipalities, high-wind and coastal requirements, and GC workflows.",
      },
    ],
  },
  {
    ...
    rows: [
      ...
      { feature: "High-wind + scope flags", cleard: true, competitor: false },
  ...
  },
  {
    ...
    name: "FCC",
    initial: "F",
    cardBlurb: "One engineer. No AI, no sub portal, no automation.",
    headline: "One engineer or\nan AI-powered platform?",
    sub: "FCC is a one-person operation running permit compliance manually. Cleard is a full platform — Victoria AI, sub portals, automated COI enforcement, and inspection management — operating at the speed of software, not headcount.",
    rows: [
      { feature: "Victoria AI permit advisor", cleard: true, competitor: false },
      { feature: "Sub management + COI enforcement", cleard: true, competitor: false },
      { feature: "Sub portal (token-based)", cleard: true, competitor: false },
    ...
    diffs: [
      ...
      },
      {
        ...
        body: "Cleard's Victoria AI predicts municipality timelines, flags scope issues before submission, and drafts correction responses. FCC relies on human review of the same information.",
      },
    ],
  },
];
