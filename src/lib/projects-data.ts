...
const SEED: Seed[] = [
  ...
  { n: 12, name: "Stoltenberg Residence", client: "Brent Stoltenberg", street: "17600 Pineapple Ln", city: "Fort Pierce", zip: "34945", scope: "Residential swimming pool", status: "permit_issued", permit_no: "" },
  { n: 13, name: "Euell", client: "Euell", street: "15742 78th Pl N", city: "Loxahatchee", zip: "33470", status: "permit_issued", permit_no: "" },
  ...
  { n: 19, name: "Manera Residence", client: "Knight Manera", street: "2006 Windward Way", city: "Vero Beach", zip: "32960", status: "permit_issued", permit_no: "" },
