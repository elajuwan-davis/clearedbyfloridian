...
export const tabGroups: TabGroup[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { label: "Inspectors", to: "/portal/contacts", search: { type: "inspector" } },
      { label: "Municipalities", to: "/portal/contacts", search: { type: "municipality" } },
      { label: "Homeowners", to: "/portal/contacts", search: { type: "homeowner" } },
      { label: "Compliance", to: "/portal/subcontractors", search: { view: "compliance" } },
