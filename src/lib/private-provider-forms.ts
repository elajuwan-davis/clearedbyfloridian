...
async function initDoc(): Promise<{ pdf: PDFDocument; ctx: DrawCtx }> {
  ...
  pdf.setCreator("Cleard by Flōridian");
  pdf.setProducer("Cleard by Flōridian");
...
export async function generateNTBO(fields: NTBOFields): Promise<Uint8Array> {
  ...
  drawFooter(ctx, "Generated by Cleard by Flōridian — review before submission.");
  return pdf.save();
}
...
export async function generateNOC(fields: NOCFields): Promise<Uint8Array> {
  ...
  drawFooter(ctx, "Generated by Cleard by Flōridian — record with County Clerk before first inspection.");
  return pdf.save();
}
