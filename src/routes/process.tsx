...
export const Route = createFileRoute("/process")({
  head: () => ({
    meta: [
      { title: "Process — How Flōridian Permits Move" },
      {
        name: "description",
        content:
          "From submittal to certificate of occupancy: how Flōridian moves residential permits through plan review and inspection under Florida's private provider statute.",
      },
      { property: "og:title", content: "Flōridian Process" },
...
const steps = [
  {
    ...
    day: "Day 0",
    t: "Intake",
    d: "You upload drawings, structural calcs, energy compliance, and product approvals into the Flōridian portal. We confirm scope within 4 business hours and issue a fixed-fee proposal.",
