...
export const Route = createFileRoute("/admin/protection")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Preliminary notices and lien rights filed from the project record." },
      { property: "og:title", content: "Protection · Admin — Cleard" },
      { property: "og:description", content: "Preliminary notices and lien rights filed from the project record." },
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6">
        ...
        <header className="mb-6">
          <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-obsidian/50">
            Preliminary Notices &amp; Lien Rights
          </div>
          <h1 className="display-serif mt-2 text-4xl text-obsidian">Protection</h1>
