      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8">
          ...
          <div className="space-y-8">
            ...
            {/* Harper Insurance featured provider */}
            <div className="p-6 rounded-[3px] border border-obsidian/12 bg-white">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                <div>
                  <div className="eyebrow text-obsidian/50">Featured Provider</div>
                  <div className="mt-2 font-display text-2xl text-obsidian">Harper Insurance</div>
                  <p className="mt-2 max-w-lg text-[13px] text-obsidian/70 leading-relaxed">
                    Specialized coverage for contractors and construction professionals — general
                    liability, workers' comp, and builders risk from an agency that knows the trade.
                  </p>
                </div>
                <div
              ...
              <Button
                asChild
                className="mt-5 rounded-[3px] gap-2 bg-obsidian text-paper hover:bg-obsidian/90"
              >
                <a
