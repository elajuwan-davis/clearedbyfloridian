...
const PROVIDERS: Provider[] = [
  {
    ...
    why: "WithCoverage underwrites GCs and specialty trades every day, understands contractor-specific requirements, and delivers certificates fast enough to keep permits and closings on schedule. A-rated carriers quoted in parallel — typically within 24 business hours.",
  ...
  },
  {
    ...
    why: "Harper is a construction-focused agency with deep national carrier relationships. They handle certificate turnarounds, additional insured endorsements, and renewal logistics with the same white-glove pace we hold ourselves to.",
