...
export const Route = createFileRoute("/forms/")({
  head: () => ({
    meta: [
      { title: "Forms — Cleard" },
      { name: "description", content: "Permit intake, subcontractor intake, and payment authorization." },
      { property: "og:title", content: "Forms — Cleard" },
      { property: "og:description", content: "Permit intake, subcontractor intake, and payment authorization." },
