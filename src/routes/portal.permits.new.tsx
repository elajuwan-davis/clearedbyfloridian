...
const DRAFT_KEY = "cleared_permit_intake_draft";
    ...
    return (
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="border border-obsidian/10 bg-white rounded-[3px] p-10 text-center">
          ...
          <h1 className="display-serif mt-4 text-3xl text-obsidian">Intake Submitted</h1>
          <p className="mt-3 text-sm text-obsidian/65">Your permit intake for {form.address || "the project"} has been received. Cleared will begin preparing the forms.</p>
          <button
            type="button"
            onClick={() => navigate({ to: "/my-permits" })}
    ...
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="border-b border-obsidian/10 pb-6">
        ...
        <div className="mt-2 flex flex-wrap items-end justify-between gap-3">
          ...
          <Link to="/my-permits" className="font-mono text-[10px] uppercase tracking-[0.14em] text-obsidian/55 hover:text-obsidian">
            Cancel
          </Link>
        </div>
        {/* Steps */}
      ...
      {hasDraft && (
        <div className="mt-6 flex items-center justify-between gap-3 border border-amber-500/30 bg-amber-50 rounded-[3px] px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-obsidian">
            <AlertCircle className="h-4 w-4 text-amber-600" />
            You have a saved draft for {form.address || "this project"}.
          </div>
          <button type="button" onClick={discardDraft} className="font-mono text-[10px] uppercase tracking-[0.14em] text-amber-700 hover:text-amber-900">
            Discard Draft
          </button>
        </div>
      )}
      ...
      {form.step === 1 ? (
        <div className="mt-6 space-y-6 bg-white border border-obsidian/10 rounded-[3px] p-6 sm:p-8">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2 pt-2 border-t border-obsidian/10">
            <button type="button" onClick={saveDraft} className="inline-flex items-center gap-2 border border-obsidian/20 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.14em] text-obsidian rounded-[3px]">
        ...
        <div className="mt-6 space-y-8">
          ...
          <div className="bg-white border border-obsidian/10 rounded-[3px] p-6 sm:p-8 space-y-5">
            ...
            <div>
              ...
              <p className="mt-1.5 text-[11px] text-obsidian/55">Only if property is in an individual's name. If under a Trust/Corp/LLC, skip and fill entity name below.</p>
            </div>
            <div>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div><label className={labelCls}>Signer Phone *</label><input required className={inputCls} value={form.signerPhone} onChange={(e) => update("signerPhone", e.target.value)} /></div>
              <div><label className={labelCls}>Signer Email *</label><input type="email" required className={inputCls} value={form.signerEmail} onChange={(e) => update("signerEmail", e.target.value)} /></div>
            </div>
          </div>
          ...
          <div className="bg-white border border-obsidian/10 rounded-[3px] p-6 sm:p-8 space-y-5">
            <div className="flex items-end justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-[12px] text-obsidian/60">In-Ground Pool with Deck — required document checklist.</p>
              </div>
            ...
            <div className="pt-2">
              ...
              <p className="mt-1 text-[12px] text-obsidian/60">You can upload up to 30 PDF files.</p>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 pt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={submit}
                className="inline-flex items-center gap-2 px-5 py-2.5 font-mono text-[10px] uppercase tracking-[0.14em] text-obsidian rounded-[3px]"
                style={{ backgroundColor: "#E4B93B" }}
              >
                <Send className="h-3.5 w-3.5" /> Submit Permit Intake
              </button>
            </div>
          </div>
        </div>
