...
import { sendForSignature, type RecipientRole } from "@/lib/signature-requests";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg rounded-[3px]">
        <DialogTitle className="display-serif text-2xl text-obsidian">Send for Signature</DialogTitle>
        <DialogDescription className="text-sm text-obsidian/70">
          Sent via Signwell. The recipient will receive a secure link to review and sign.
        </DialogDescription>
        ...
        <div className="mt-4 space-y-4">
          ...
          <div>
            <Label className="font-mono text-[10px] uppercase tracking-[0.14em] text-obsidian/55">Recipient Role</Label>
          ...
          <div>
            <Label className="font-mono text-[10px] uppercase tracking-[0.14em] text-obsidian/55">Recipient Email</Label>
            <Input
              type="email"
              value={email}
          ...
          <div>
            <Label className="font-mono text-[10px] uppercase tracking-[0.14em] text-obsidian/55">Message (optional)</Label>
            <Textarea
              value={message}
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <Button variant="dark" className="rounded-[3px]" onClick={submit} disabled={!email.trim() || busy}>
