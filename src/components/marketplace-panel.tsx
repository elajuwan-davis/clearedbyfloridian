...
export function MarketplacePanel() {
  ...
  return (
    <>
      <section className="mt-8 rounded-[3px] border border-[#000000]/30 bg-[#E6E6FA]/15 p-6 sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="max-w-xl">
            <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.16em] text-[#000000]">
