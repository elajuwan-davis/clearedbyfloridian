      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/product" className="hover:opacity-70 transition-opacity">Services</Link></li>
            <li><Link to="/product" className="hover:opacity-70 transition-opacity">Process</Link></li>
