// Compliance / COI view for subcontractor records. Shares the same
// underlying subcontractor rows as the Subcontractors list.
...
import { Split, Panel, StatTile, StatusChip, TableShell, EmptyState } from "@/components/ui-kit";

export function SubsComplianceView() {
                  ...
                  {subs.map((s) => {
                    ...
                    return (
                      <tr key={s.id}>
                        ...
                        <td className="text-muted-foreground">{s.coi_expiration || "—"}</td>
                        <td className="text-muted-foreground">
                          {(s as any).coverage_type || "General Liability"}
                        </td>
        ...
        <>
          <div className="grid grid-cols-2 gap-2">
            <StatTile
              ...
              value={withCoiExpiring.length}
              tone={withCoiExpiring.length ? "warning" : "neutral"}
            />
            ...
            {loading ? (
              ...
              <div className="flex items-center gap-2.5 px-3 py-3">
                ...
                <div className="text-[12px] text-muted-foreground">
                  All COIs on file are 60+ days from expiration.
                </div>
              </div>
            ) : (
